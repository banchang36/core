...
class Predictor:
    ...
    def init_model(self, args):
        ...
        checkpoint_path = os.path.join(args.model_dir, args.ckpt_id)
    ...
    def handle_batch(self, full_batch):
        ...
        for n_iter in range(self.iteration_count):
            ...
            #print("batch_input_dict", batch_input_dict)
    ...
    def predict(self, batch_inputs):
        ...
        print('label_probs:',label_probs.tolist())
        print("label_ids:",label_ids.tolist())
